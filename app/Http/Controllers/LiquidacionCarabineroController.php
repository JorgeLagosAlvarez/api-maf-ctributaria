...
class LiquidacionCarabineroController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = Validator::make($request->all(), [
            ...
            'total_haber' => ['required', 'numeric', 'digits_between:5,8'],
            'descuentos_legales' => ['required', 'numeric', 'digits_between:5,8'],
            'monto_liquido' => ['required', 'numeric', 'digits_between:5,8'],
